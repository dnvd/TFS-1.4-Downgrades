...
elseif msgcontains(msg, 'spark') or msgcontains(msg, 'phoenix') then
	npcHandler:say("The spark of the phoenix is given by me and by the great geomancer of the local earthtemple. Do you wish to receive my part of blessing of the phoenix for 10.000 gold?", cid)
	talk_state = 1394
...
elseif talk_state == 1394 and msgcontains(msg, 'yes') then
	if getPlayerStorageValue(cid, 1339) >= 1 then
		if doPlayerRemoveMoney(cid, 10000) == true then
			...
			npcHandler:say("So receive the mark of the flame and be blessed by the phoenix, pilgrim.", cid)
