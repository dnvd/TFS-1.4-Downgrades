...
function creatureSayCallback(cid, type, msg) msg = string.lower(msg)
	...
	elseif talk_state == 1 and msgcontains(msg, 'poison wall') then
		npcHandler:say("Say the words: adevo mas grav pox", cid)
	...
	elseif talk_state == 1 and msgcontains(msg, 'fire wall') then
		npcHandler:say("Say the words: adevo mas grav flam", cid)
	...
	elseif talk_state == 1 and msgcontains(msg, 'energy wall') then
		npcHandler:say("Say the words: adevo mas grav vis", cid)
	...
	elseif msgcontains(msg, 'poison wall') or msgcontains(msg, 'Poison wall') then
		npcHandler:say("With this one you can create a huge wall of poisonous gas. Many monsters will be too scared to pass the wall and if they do, they will choke from nausea.", cid)
	...
	elseif msgcontains(msg, 'fire wall') or msgcontains(msg, 'Fire wall') then
		npcHandler:say("As the poison wall, this spell creates an even larger wall of fire, burning everyone who passes.", cid)
	...
	elseif msgcontains(msg, 'energy wall') or msgcontains(msg, 'Energy wall') then
		npcHandler:say("Attracts lightning bolts from the sky, to form a giant wall, seriously damaging everyone who passes.", cid)
