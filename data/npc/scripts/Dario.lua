...
npcHandler:say({
	"I sell 'find person, ', 'light', 'create food', 'light healing', 'light magic missile', 'antidote', 'intense healing', 'conjure arrow', 'great light', 'heavy magic missile', 'magic shiel', 'fireball' and. ...",
