...
npcHandler:say({
	"... I teach for.. 'find person', 'light', 'light healing', 'light magic missile', 'antidote', 'intense healing', 'poison field', 'great light', 'fire field', 'heavy magic missile', 'magic shield', 'fireball', 'energy field', 'destroy field' and. ...",
