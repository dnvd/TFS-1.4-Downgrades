...
npcHandler:say({
	"... I teach... 'Find Person', 'Light', 'Create Food', 'Light Healing', 'Ligh Magic Missile', 'Antidote', 'Intense Healing', 'Poison Field', 'Great Light', 'Fire Field', 'Heavy Magic Missile', 'Magic Shield', 'Intense Healing Rune', 'Fireball' and. ...",
	"'Energy Field', 'Destroy Field', 'Ultimate healing', 'Great Fireball', 'Firebomb', 'Creature Illusion', 'Convince Creature', 'Ultimate Healing Rune', 'Chameleon', 'Poison Wall', 'Explosion', 'Fire Wall', 'Invisible', 'Summon Creature' and 'Energy Wall'."},
	cid)
talk_state = 0
