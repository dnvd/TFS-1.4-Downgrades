...
elseif msgcontains(msg, 'spell') or msgcontains(msg, 'Spell') then
	...
	npcHandler:say({
		"For you my friend, I sell 'Find Person', 'Light', 'Create Food', 'Light Healing', 'Light Magic Missile', 'Antidote', 'Intense Healing', 'Conjure Arrow', 'Great Light', 'Heavy Magic Missile', 'Magic Shield' and. ...",
		"'Fireball', 'Poison Arrow', 'Destroy Field', 'Ultimate Healing', 'Explosive Arrow' and 'Invisible'."},
		cid)
	end
	talk_state = 0
