...
npcHandler:say({
	"I sell 'Find Person', 'Light', 'Create Food', 'Light Healing', 'Light Magic Missile', 'Antidote', 'Intense Healing', 'Poison Field', 'Great Light', 'Fire Field', 'Heavy Magic Missile', 'Magic Shield', 'Intense Healing Rune', 'Antidote Rune' and. ...",
	"'Fireball', 'Energy Field', 'Destroy Field', 'Ultimate Healing', 'Great Fireball', 'Firebomb', 'Creature Illusion', 'Convince Creature', 'Ultimate Healing Rune', 'Chameleon', 'Poison Wall', 'Explosion' and. ...",
	"'Fire Wall', 'Invisible', 'Summon Creature' and 'Energy Wall'."},
	cid)
talk_state = 0
