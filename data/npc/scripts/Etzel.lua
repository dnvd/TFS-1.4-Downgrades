...
npcHandler:say({
	"I can sell you 'find person', 'light', 'light healing', 'light magic missile', 'antidote', 'intense healing', 'poison field', 'great light', 'fire field', 'heavy magic missile', 'magic shiel', 'fireball', 'energy field', 'destroy field' and. ...",
