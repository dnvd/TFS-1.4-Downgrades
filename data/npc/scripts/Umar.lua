...
elseif talk_state == 801 and msgcontains(msg, "yes") then
	npcHandler:say({
		...
		"Go in through the backdoor of the green djinn fortress, and assassinate 100 djinns. ...",
...
elseif talk_state == 601 and msgcontains(msg, "yes") then
	npcHandler:say({
		...
		"You're welcome as a guest in our fortess, go and kill some green djinns when ever you want!"},
		cid)
