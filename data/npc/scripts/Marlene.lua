...
elseif msgcontains(msg, 'rumour') or msgcontains(msg, 'Rumour') then
	npcHandler:say({
		...
		"I heard they are allmighty and have incredible powers! I already packed our stuff for an emergency escape. You never know. Maybe they plan to conquer the whole world. ...",
