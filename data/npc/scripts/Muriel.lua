...
npcHandler:say({
	"I sell 'Find Person', 'Light', 'Light Healing', 'Light Magic Missile', 'Antidote', 'Intense Healing', 'Poison Field', 'Great Light', 'Fire Field', 'Heavy Magic Missile', 'Magic Shiel', 'Fireball', 'Energy Field', 'Destroy Field', 'Fire Wave' and. ...",
