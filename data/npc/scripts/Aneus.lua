...
npcHandler:say({
	"The development of the city was fine. Also a giant castle was build northeast of the city. ...",
	"But more and more workers started to rebel because of the bad conditions."},
	cid)
talk_state = 5

elseif talk_state == 5 and msgcontains(msg, 'rebel') and npcHandler.focus == cid then
npcHandler:say({
	"All rebels were brought to the giant castle. Guarded by the Red Legion, they had to work and live in even worse conditions. ...",
	"Also some friends of the king's sister were brought there."},
	cid)
talk_state = 6

elseif talk_state == 6 and msgcontains(msg, 'friends') and npcHandler.focus == cid then
npcHandler:say({
	"The king's sister was pretty upset about the situation there but her brother didn't want to do anything about this matter. ...",
	"So she made a plan to destroy the Red Legion for their cruelty forever."},
	cid)
talk_state = 7
...
npcHandler:say({
	"Most of the Red Legion went to the island by night. The orcs were not prepared and the Red Legion killed hundreds of orcs with nearly no loss. ...",
	"After they were satisfied they walked back to the castle."},
	cid)
talk_state = 10
...
npcHandler:say({
	"She tried to rescue the workers but it was too late. The orcs started immediately to attack her troops, too. ...",
	"Her royal troops went back to the city. A trick saved the city from destruction."},
	cid)
talk_state = 12

elseif talk_state == 12 and  msgcontains(msg, 'trick') and npcHandler.focus == cid then
npcHandler:say({
	"They used the same trick as against the Red Legion and the orcs started to fight their non-orcish-allies. ...",
