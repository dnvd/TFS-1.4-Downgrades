...
function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'heal') then
		...
		elseif getCreatureHealth(cid) < 40 then
			...
			npcHandler:say('You aren\'t looking that bad. Sorry, I can\'t help you. But if you are looking for additional protection you should go on thepilgrimage of ashes.', cid)
		end
	end
	return true
end
