...
elseif msgcontains(msg, 'spell') then
	...
	npcHandler:say({
		"for you, I sell 'Find Person', 'Light', 'Light Healing', 'Light Magic Missile', 'Antidote', 'Intense Healing', 'Poison Field', 'Great Light', 'Fire Field', 'Heavy Magic Missile', 'Magic Shield', 'Fireball', 'Energy Field', 'Destroy Field' and. ...",
		"'Fire Wave', 'Ultimate Healing', 'Great Fireball', 'Firebomb', 'Energy Beam', 'Creature Illusion', 'Poison Wall', 'Explosion', 'Fire Wall', 'Great Energy Beam', 'Invisible', 'Summon Creature', 'Energy Wall', 'Energy Wave' and 'Sudden Death'."},
		cid)
	talk_state = 0

	elseif getPlayerVocation(cid) == 2 or getPlayerVocation(cid) == 6 then
	npcHandler:say({
		"for you, I sell 'Find Person', 'Light', 'Create Food', 'Light Healing', 'Light Magic Missile', 'Antidote', 'Intense Healing', 'Poison Field', 'Great Light', 'Fire Field' and. ...",
		"'Heavy Magic Missile', 'Magic Shield', 'Intense Healing Rune', 'Antidote Rune', 'Fireball', 'Energy Field', 'Destroy Field', 'Ultimate Healing', 'Great Fireball', 'Firebomb', 'Creature Illusion', 'Convince Creature', 'Ultimate Healing Rune' and. ...",
		"'Chameleon', 'Poison Wall', 'Explosion', 'Fire Wall', 'Invisible', 'Summon Creature' and 'Energy Wall'."},
		cid)
	talk_state = 0
	end
